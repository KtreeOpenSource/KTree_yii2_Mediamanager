  ...
  var parent = $(this).parent().attr('id');
    ...
    if (clicks === 1) {
        timer = setTimeout(function () {
          ...
          var url = "/filemanager/file/filemanager-view?parent="+parent+"&popup="+popup;
            ...
            $('li.jstree-node').each(function(){
              var id = $(this).attr('id');
                if(($(this).children('div[class=folder-extra-options]').length) == 0){
                  $('#'+id+' a[id='+id+'_anchor]').after('<div class="folder-extra-options" id="'+id+'"><i class="fa fa-ellipsis-h" aria-hidden="true"></i><ul style="display:none;" id="'+id+'_folder_options" class="folder-extra-options-content"><li><a data-id="'+id+'" href="'+base_url+'/filemanager/file/delete?id='+id+'" title="delete" role="mediafile-delete" type="folder" data-pjax="0">Delete</a></li></ul></div>');
                }
            });
          }
        });
    ...
    function addDateRangePicker(className){
...
$('#jsTree_mediafile-filename').bind("open_node.jstree", function (e, data) {
  ...
  $(info.children).each(function(key,value){
    if(($('#'+value).children('div[class=folder-extra-options]').length) == 0){
      $('#'+value+' a[id='+value+'_anchor]').after('<div class="folder-extra-options" id="'+value+'"><i class="fa fa-ellipsis-h" aria-hidden="true"></i><ul style="display:none;" id="'+value+'_folder_options" class="folder-extra-options-content"><li><a data-id="'+value+'" href="'+base_url+'/filemanager/file/delete?id='+value+'" title="delete" role="mediafile-delete" type="folder" data-pjax="0">Delete</a></li></ul></div>');
    }
  });
});
...
$('#jsTree_mediafile-filename').bind("refresh.jstree", function () {
  $('li.jstree-node').each(function(){
    var id = $(this).attr('id');
    if(($(this).children('div[class=folder-extra-options]').length) == 0){
      $('#'+id+' a[id='+id+'_anchor]').after('<div class="folder-extra-options" id="'+id+'" href="#"><i class="fa fa-ellipsis-h" aria-hidden="true"></i><ul style="display:none;" id="'+id+'_folder_options" class="folder-extra-options-content"><li><a data-id="'+id+'" href="'+base_url+'/filemanager/file/delete?id='+id+'" title="delete" role="mediafile-delete" type="folder" data-pjax="0">Delete</a></li></ul></div>');
    }
  });
});
...
/**
  ...
  var BodyHtml = '<div class="global-loader"><div class="ui-widget-overlay1"></div><div class="content-loader">Please Wait....<div class="clear"></div></div></div>';
